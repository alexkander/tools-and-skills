...
- `taskrail checks` exists (`tools/taskrail/src/taskrail/checks.py`, `cmd_checks` in `cli.py`) with
...
### `tools/taskrail/src/taskrail/skills/taskrail-autopilot/references/lane-brief.md`
...
### `tools/taskrail/src/taskrail/skills/taskrail-autopilot/SKILL.md`
...
### `tools/taskrail/src/taskrail/skills/taskrail-autopilot/references/gate-review.md`
...
### `tools/taskrail/tests/test_autopilot_skill.py`
