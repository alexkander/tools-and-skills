...
| Task | Title | Document |
|------|-------|----------|
| T013 | Clarify workspace base, stage commits and agent restart in the taskrail skills | [T013-clarify-workspace-base-stage-commits-and.md](T013-clarify-workspace-base-stage-commits-and.md) |
| T002 | Tag and publish taskrail-v0.1.0 | [T002-tag-and-publish-taskrail-v0-1-0.md](T002-tag-and-publish-taskrail-v0-1-0.md) |
| T016 | Bump taskrail on main to 0.2.0.dev0 after the 0.1.0 tag | [T016-bump-taskrail-on-main-to-0-2-0-dev0-afte.md](T016-bump-taskrail-on-main-to-0-2-0-dev0-afte.md) |
