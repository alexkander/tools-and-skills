...
- `tools/taskrail/src/taskrail/integrations/opencode.md`, section
...
- `tools/taskrail/tests/test_autopilot_skill.py` — one new test, parametrized over `opencode` alone
...
- `tools/taskrail/DESIGN.md` (governing) — the exact text is Decision 1 below.
- `tools/taskrail/CHANGELOG.md` — one entry under *Unreleased*:
