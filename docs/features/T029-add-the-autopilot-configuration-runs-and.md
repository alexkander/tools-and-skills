...
- `tools/taskrail/src/taskrail/autopilot/` (new package): `__init__.py`, `runs.py`, `status.py`,
  `commands.py`.
- `tools/taskrail/src/taskrail/config.py` — `AutopilotConfig`, `Config.autopilot`, and
...
- `tools/taskrail/tests/test_autopilot.py` (new); `tools/taskrail/tests/test_claims.py` (one
  assertion).
