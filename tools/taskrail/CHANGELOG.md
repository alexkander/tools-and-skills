...
Releases are tagged `taskrail-vX.Y.Z`. Install one with:

```bash
uv tool install taskrail --from "git+https://github.com/alexkander/tools-and-skills.git@taskrail-vX.Y.Z#subdirectory=tools/taskrail"
```
